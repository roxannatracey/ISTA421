...
namespace DelLab03
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            GetPresDel myFirstDel = new GetPresDel(first.GetFirstName); // getpresdel is a type 
            // .getfirstname is a method because it is applying the property to first. when you assign a 
            // method to a delegate you dont need the parenthesis 
            Console.WriteLine(myFirstDel()); // this is going to print the first name 
